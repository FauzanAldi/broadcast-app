@extends('yasin.domisili.layout-domisili')
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-text-content">
                        <p><a rel="nofollow noopener" href="{{ url('') }}" target="_parent">Yasin Murah ID</a> adalah Pusat Cetak Buku Yasin dan Tahlil Profesional dengan JAMINAN Harga Termurah di {{ $r->name }}. 
                      ...
                      <br><br><b>GRATIS ONGKOS KIRIM KE *{{ $r->name }}*  PESAN SEKARANG JUGA.</b></p>
                    </div>
                </div>
            </div>
        </div>
